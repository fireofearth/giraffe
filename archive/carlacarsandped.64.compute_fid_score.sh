...
#SBATCH --job-name=giraffe.carlacarsandpedv1.64.compute_fid_score
...
python compute_fid_score.py \
	--image-directory data/carlacarsandpedv1/images/64 \
	--out-directory data/carlacarsandpedv1/fid_files \
	--label carlacars_64
