...
#SBATCH --job-name=giraffe.carlacars_static_altandshift.64.compute_fid_score
...
python compute_fid_score.py \
	--image-directory data/carlacars_static_altandshift/images/64 \
	--out-directory data/carlacars_static_altandshift/fid_files \
	--label carlacars_64

carlacars_static_altandshift.64.compute_fid_score.sh
