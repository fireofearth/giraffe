...
#SBATCH --job-name=giraffe.carlacars_static_camera.32.downsample_images
...
python downsample_images.py \
	--image-directory data/carlacars_static_camera/images/256 \
	--out-directory data/carlacars_static_camera/images/32 \
	--size 32
