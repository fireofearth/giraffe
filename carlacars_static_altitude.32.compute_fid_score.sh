...
#SBATCH --job-name=giraffe.carlacars_static_altitude.32.compute_fid_score
...
python compute_fid_score.py \
	--image-directory data/carlacars_static_altitude/images/32 \
	--out-directory data/carlacars_static_altitude/fid_files \
	--label carlacars_32
